...
export class HomeComponent {
  ...
  catalogue: CatItem[] = [
    ...
    { title: 'Human Resources Tracker', route: '/coming-soon', iconPath: 'M16 11a4 4 0 1 0-8 0 4 4 0 0 0 8 0Zm-12 10a6 6 0 0 1 12 0v1H4v-1Zm13.5-7.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7ZM20 22v-1a7.9 7.9 0 0 0-2.2-5.4A5.9 5.9 0 0 1 22 21v1h-2Z' },
